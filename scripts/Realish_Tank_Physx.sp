...
public OnPluginStart()
{
	...
	hCvar_fRockForce = CreateConVar("rtp_rockforce", "1000.0", "Force of the rock, very high values send you flying very fast&far", FCVAR_NOTIFY, true, 1.0, true, 2147483647.0);
