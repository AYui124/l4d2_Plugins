...
public void OnPluginStart()
{
	...
	CreateConVar(						"l4d2_fireworks_version",			PLUGIN_VERSION,	"Fireworks Party plugin version.", CVAR_FLAGS|FCVAR_DONTRECORD);
...
public Action tmrRandomFirework(Handle timer, DataPack hPack)
{
	float vPos[3], vAng[3];
...
//					PARTICLES
// ====================================================================================================
void PrecacheParticle(const char[] sParticle)
{
...
public Action tmrPlayBurst(Handle timer, DataPack hPack)
{
	float vPos[3];
