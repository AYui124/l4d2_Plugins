...
public void OnPluginStart()
{
	...
	g_hCvarType =			CreateConVar(	"l4d_target_override_type",				"3",				"How should the plugin search through Survivors. 1=Nearest visible (defaults to games method on fail). 2=All Survivors from the nearest. 3=Nearest by flow distance (requires Left4DHooks plugin, defaults to type 2).", CVAR_FLAGS );
