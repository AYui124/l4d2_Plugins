...
public void OnPluginStart()
{
	...
	g_hCvarCharge =			CreateConVar(	"l4d2_charger_punch_charging",		"1",				"Only fling survivors when punched by a Charger that is charging. 0=No. 1=Yes. Very hard to punch and hit while charging, added by request.", CVAR_FLAGS );
	...
	g_hCvarForce =			CreateConVar(	"l4d2_charger_punch_force",			"300.0",			"The velocity a survivors is flung when punched by the Charger.", CVAR_FLAGS );
	g_hCvarForceZ =			CreateConVar(	"l4d2_charger_punch_forcez",		"300.0",			"The vertical velocity a survivors is flung when punched by the Charger. Must be greater than 250 to lift a Survivor.", CVAR_FLAGS );
