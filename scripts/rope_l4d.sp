...
{ 	 
	...
	l4d_rope_drop_from_witch = CreateConVar("l4d_rope_drop_from_witch", "50.0", " ", FCVAR_PLUGIN);
 	l4d_rope_drop_from_tank = CreateConVar("l4d_rope_drop_from_tank", "50.0", "", FCVAR_PLUGIN);
