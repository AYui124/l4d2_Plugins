...
public void OnPluginStart()
{
	...
	g_hCvarRepeat =	CreateConVar(		"l4d2_charger_repeat",		"1",	"0=Off. 1=Allow charging while carrying either after charging or after grabbing a survivor and after the charge meter has refilled.", CVAR_FLAGS);
	g_hCvarShove =	CreateConVar(		"l4d2_charger_shove",		"1",	"Survivors can shove chargers to release pummeled victims. 0=Off. 1=Release only. 2=Stumble survivor. 4=Stumble charger. 7=All. Add numbers together.", CVAR_FLAGS);
